...
public class MatriculacionEntity {
	...
	public MatriculacionEntity(Integer id, AsignaturaEntity idAsignatura, AlumnoEntity idAlumno,String fecha,
			Integer activo) {
		super();
	...
	public MatriculacionEntity(AsignaturaEntity asignatura, AlumnoEntity alumno, String fecha, CajaEntity caja) {
		super();
		this.asignatura = asignatura;
		this.alumno = alumno;
		this.fecha = fecha;
